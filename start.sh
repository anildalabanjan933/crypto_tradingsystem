...
screen -dmS signal_generator bash -c "cd $REPO && set -a && source $REPO/.env && set +a && $REPO/.venv/bin/python3 scripts/renko_state_engine.py >> logs/renko_chart_engine.log 2>&1"
