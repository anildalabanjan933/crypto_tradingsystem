...
screen -dmS signal_generator bash -c "cd $REPO && set -a && source $REPO/.env && set +a && $REPO/.venv/bin/python3 scripts/live_signal_generator.py >> logs/live_signal_generator.log 2>&1"
