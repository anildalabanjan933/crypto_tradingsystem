# run_backtest_eth.py
# Runner script for ETH Renko Reversal strategy backtest (Phase 6)
# Edit the CONFIG block below to change any settings, then run:
#   python run_backtest_eth.py
...
CONFIG = {
    ...
    # ── Data ──────────────────────────────────────────────────────────
    'csv_path'        : 'data/eth_2h_delta.csv',
    'symbol'          : 'ETHUSD',
    'start_date'      : None,
    'end_date'        : None,
    ...
    'sr_tolerance'    : 0.5,      # 0.5 * $10 box = $5 band
