...
def _frag_analysis():
    ...
    _d2_full = _load14('output/trade_log_RenkoReversal*.csv', _full_from)
    _d4_full = _load14('output/trade_log_RenkoSMIIOSupertrend*.csv', _full_from)
    system = load_config().get('system', {})
    _df2_fwd = _load14_fwd(84, system.get('s2_api_key',''), system.get('s2_api_secret',''), system.get('base_url','https://cdn-ind.testnet.deltaex.org'))
    _df4_fwd = _load14_fwd(84, system.get('s4_api_key',''), system.get('s4_api_secret',''), system.get('base_url','https://cdn-ind.testnet.deltaex.org'))
