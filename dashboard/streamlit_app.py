...
with st.expander('SECTION 14 - BACKTEST ANALYSIS + DEPLOYMENT PLAN', expanded=st.session_state.get('exp_14s', False)):
    ...
    def _tbl14(d2, d4, label, period_str, df2=None, df4=None):
        ...
        {_row9("Max Drawdown",f"-₹{s2_dd:,.0f}",f"-₹{s4_dd:,.0f}",f"-₹{port_dd:,.0f}",f"-₹{s2_dd:,.0f}",f"-₹{s4_dd:,.0f}",f"-₹{port_dd:,.0f}",_fna(fw2_dd),_fna(fw4_dd),_fna(fwp_dd),_TDR14B,_TDR14B,_TDR14B,_TDR14B,_TDR14B,_TDR14B,_TDR14B,_TDR14B,_TDR14B)}
        ...
        {_row9("Max DD Period Loss",f"-₹{s2_ddl:,.0f}",f"-₹{s4_ddl:,.0f}",f"-₹{port_ddl:,.0f}",f"-₹{s2_ddl:,.0f}",f"-₹{s4_ddl:,.0f}",f"-₹{port_ddl:,.0f}",_fna(fw2_ddl),_fna(fw4_ddl),_fna(fwp_ddl),_TDR14B,_TDR14B,_TDR14B,_TDR14B,_TDR14B,_TDR14B,_TDR14B,_TDR14B,_TDR14B)}
