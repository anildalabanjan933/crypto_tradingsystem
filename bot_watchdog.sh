...
check_heartbeat_stale position_risk_monitor logs/position_risk_monitor_heartbeat.txt 300
...
check_heartbeat_stale maintenance_watcher logs/maintenance_watcher_heartbeat.txt 300
